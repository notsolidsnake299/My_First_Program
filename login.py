...
while True:
    ...
    print("you can run my other program if you want.") 
    print("I'm so glad you're trying out my programs! Thanks for taking the time to look at this beginner programmer's code. <3")
    time.sleep(2)
